    ...
    return (
        <div className='applyContainer'>
            ...
            <div className='mobilViewText'>
                <p>
                    In the ever-evolving domain of artificial intelligence, Mood Global Services is
                    in search of a Machine Learning and Python Specialist to spearhead our AI
                    initiatives. The world of machine learning offers endless possibilities, from
                    predictive analytics to natural language processing and beyond. As our
                    specialist, you will play a pivotal role in harnessing these possibilities,
                    turning data into actionable insights, and driving innovation.
                </p>
                <p>
                    Your expertise in Python, combined with your deep understanding of machine
                    learning frameworks, will be instrumental in developing, deploying, and
                    optimizing our machine learning models. You will collaborate with our software
                    development team, ensuring that these models are seamlessly integrated into our
                    applications, enhancing user experience and functionality.
                </p>
            </div>
            <div className='applyQualifications'>
                <div className='responsibilities'>
                    ...
                    <ul>
                        <li>
                            Design, develop, and deploy machine learning models using frameworks
                            like TensorFlow, Keras, PyTorch, and scikit-learn.
                        </li>
                        <li>
                            Implement and maintain cloud-based solutions for deploying ML models
                            using AWS and Firebase/Firestore.
                        </li>
                        <li>
                            Work closely with the software development team to integrate ML models
                            into applications, ensuring seamless user experience.
                        </li>
                        <li>
                            Stay updated with the latest advancements in ML and AI, and proactively
                ...
                <div className='bonusQualifications'>
                    ...
                    <ul>
                        <li>
                            AWS Certified Machine Learning or Professional Machine Learning Engineer
                            certification.
                        </li>
                    </ul>
                </div>
