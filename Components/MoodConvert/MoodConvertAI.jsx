                    ...
                    <div className='smallBackground'>
                        <div className='moodConvertAIContainer'>
                            <Image
                                ...
                                src={logo}></Image>
                            <h3>
                                As a Blockchain-based firm, we help our clients integrate the most
                                optimal blockchain solutions <br />
                                into their business strategy. We have developed a range of
                                specialised services aimed at helping <br /> companies to fully
                                exploit blockchain technologies.
                            </h3>
                        </div>
                    </div>
                </div>
                <form
                    className='AIformContainer'
                    action=''>
