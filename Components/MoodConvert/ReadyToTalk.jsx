      ...
      <div className="imageContainer">
        ...
        <div className="readyText">
          ...
          <p id="readyContent">
            ...
            needs,get expert advice,or request a quote. Your journey starts with
            a call.
          </p>

          <button id="quoteButton" onClick={handleClick}>
            GET A QUOTE NOW
          </button>
          <div id="myModal" className="modal">
            <div className="modal-content">
              ...
              <form onSubmit={formik.handleSubmit} className="form">
                ...
                <p>
                  Our team is here to assist you.Reach out now to discuss your
                  needs,get expert advice,or request a quote. Your journey
                  starts with a call.
                </p>
                <input
                  name="name"
