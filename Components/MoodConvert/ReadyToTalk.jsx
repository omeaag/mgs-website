  ...
  return (
		<div className="readyContainer">
			<div className="imageContainer">
				<Image src={isTabletOn ? office : office2} alt="office" />

				<div className="readyText">
					<h1 id="readyHeader">Ready To Talk? Contact Us Today</h1>
					<p id="readyContent">Our team is here to assist you.Reach out now to discuss your needs,get expert advice,or request a quote. Your journey starts with a call.</p>

					<button aria-label="GET A QUOTE NOW" id="quoteButton" onClick={handleClick}>
						GET A QUOTE NOW
					</button>
					<div id="myModal" className="modal">
						<div className="modal-content">
							<span className="close" onClick={closeSpan}>
								&times;
							</span>
							<form onSubmit={formik.handleSubmit} className="form">
								<h1>Get A Quote For Free</h1>
								<p>Our team is here to assist you.Reach out now to discuss your needs,get expert advice,or request a quote. Your journey starts with a call.</p>
								...
								<input name="phone" type="text" placeholder="Phone" value={formik.values.phone} onChange={formik.handleChange} onBlur={formik.handleBlur} />
								{formik.errors.phone && formik.touched.phone && <div className="error">{formik.errors.phone}</div>}
								<textarea name="message" rows="6" value={formik.values.message} onChange={formik.handleChange} onBlur={formik.handleBlur} placeholder="Message"></textarea>
								{formik.errors.message && formik.touched.message && <div className="error">{formik.errors.message}</div>}
								<div>
									<button aria-label="Submit Feedback" id="submitButton" type="submit">
										Submit Feedback
									</button>
								</div>
							</form>
