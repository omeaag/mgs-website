...
export default function Header() {
  ...
  return (
    <div className="HeaderContainer">
      ...
      >
        <Image src={isMobileMenuOpen ? close : menu} alt="menu" />
      </button>
      {isMobileMenuOpen && (
        <div className="dropdownContainer efect">
          <div className="MobileDropdownMenu">
            ...
            <Link onClick={toggleMobileMenu} href="/mood-convert">
              MoodConvert
            </Link>
            <Link onClick={toggleMobileMenu} href="/careers">
              Careers
            </Link>
          </div>
          <div className="HeaderIcons">
            ...
            <Link href="https://www.instagram.com/moodglobalservices/">
              <Image src={instaIcon} id="instaIcon" alt="instagram-logo" />
            </Link>
          </div>
          <div className="leftFooter">
            <h6>
              © &nbsp;2023 &nbsp;Mood Global Services. All rights reserved.
            </h6>
          </div>
        </div>
      )}
