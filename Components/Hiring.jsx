  ...
  const advertisement = [
    {
      ...
      description:
        "We are looking for Senior-level Python Specialist to join our team.",
    ...
    },
    {
      ...
      description:
        "We are lookin for an experienced Engineering Manager to join our team.",
      features: ["Remote", "Full-time"],
    },
    {
      title: "Full Stack Developer",
      description:
        "We are lookin for an experienced Full Stack Developer to join our team.",
      features: ["Remote", "Full-time"],
    },
  ];
