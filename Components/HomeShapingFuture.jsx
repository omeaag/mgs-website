  ...
  return (
    <div className="frame">
      ...
      <p className="at-mood-global">
        At Mood Global Services, we&#39;re committed to crafting and setting up
        digital infrastructures that enhance valuable network communication and
        stimulate business progression.
      </p>
