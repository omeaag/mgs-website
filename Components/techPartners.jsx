    ...
    return (
        <div className='techParentContainer'>
            <div className='techTextParentContainer'>
                ...
                <p>
                    Mood Global Services Hub gives startups and third parties a place to
                    conceptualize and build their ideas. The hub <br />
                    is the space where ideas become reality, by providing the necessary
                    infrastructure and services that supports <br />
