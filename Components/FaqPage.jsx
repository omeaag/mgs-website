        ...
        <div className="termsConditionsAllContainer">
            ...
            <div className="termsConditionsText">
                ...
                <div className="FaqContainer">
                    ...
                    <div className="FaqLowerDiv">
                        {showStates[1] ? <p>Blockchain technology offers numerous benefits, including increased security and transparency, improved efficiency and speed of transactions, reduced costs, and greater accountability.</p> : null}
                    </div>
                </div>
                <div className="FaqContainer">
                    <div className="FaqUpperDiv">
