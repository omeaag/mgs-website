...
function Privacypolicy() {
    ...
    const textArray = [
        ...
        },
        {
            ...
            li1: [`activities relating to pre-contractual information and any further activity instrumental to the signing and execution of the contract with third-party operators, including the activation of products and services offered by such operators;`,
        ...
        },
        {
            ...
            p3: <u><strong>For the fulfillment of contractual obligations (art. 6, co. 1, par. b, GDPR)"</strong></u>,
            ...
            p6: <u><strong>For the fulfillment of legal obligations (art. 6, co. 1, par. c, GDPR):</strong></u>,
            ...
            p10: <u><strong>To protect legitimate interests (art. 6, co. 1, par. f, GDPR):</strong></u>,
            ...
            p12: <u><strong>In accordance with the user's consent (art. 6, co. 1, par. a, GDPR):</strong></u>,
            ...
            li1: [`as the Personal Data is necessary for the execution of the general conditions of the Services stipulated between the user and Mood Global Services B.V.; and/or`,
            ...
            li3: [],
            li4: [],
            li5: [`account management (e.g. continuous updating of user data);`,
            ...
            li6: [],
            li7: [`contract management, accounting and invoicing;`
                , `compliance and risk management;`
                , `monitoring for the prevention of fraud, abuse (e.g. for illegal purposes), money laundering`
            ],
            li8: [],
            li9: [`consultation of credit agencies to determine solvency and insolvency risks.`],
            li10: [`contract management, accounting and invoicing;`
                , `compliance and risk management;`
                , `monitoring for the prevention of fraud, abuse (e.g. for illegal purposes), money laundering`
            ],
            li11: [`the prevention of fraud, abuse (e.g. for illegal purposes), money laundering and terrorist financing;`,
            ...
            li12: [],
            li13: [`direct marketing and advertising (for example, user satisfaction surveys, newsletters, prize competitions and other advertising communications);`
        ...
        },
        {
            ...
            p2: <u><strong>Data transfer within Mood Global Services or to third parties</strong></u>,
            ...
            p7: <u><strong>Transfer of data to third parties other than those mentioned above</strong></u>,
            ...
            p10: <u><strong>Place of processing of Personal Data and non-EU countries</strong></u>,
            ...
            li1: [`consultants, accountants or lawyers who provide services that are functional or connected to the execution of the general conditions governing the Services;`,
        ...
        },
        {
            ...
            p2: `Upon receipt of express written consent, Mood Global Services B.V. may proceed to profile the user using the Personal Data for the sole purpose of improving its Services, identifying and selecting homogeneous groups of users.`,
            li1: [`request and obtain access to your Personal Data from the Data Controller;`,
