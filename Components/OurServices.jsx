			...
			<div className="blueServiceContainer">
				<div className="blueContentContainer">
					<div className="headServiceText">
						<h1>Our Services</h1>
						<h6>
							At Mood Global Services, we offer a spectrum of services to navigate your business through the digital tide. Whether it's comprehensive consulting, crafting smart contracts,
							mobile app development, or pioneering software solutions for Web 2.0 and 3.0, we are with you in every stride of your digital transformation journey.
						</h6>
					</div>
					{isMobileOn ? (
						<div className="serviceBoxContainer">
							...
							<div className="serviceBContainer">
								...
								<div className="bRightService">
									...
									>
										<Image alt="turkuazHere" src={turkuazHere}></Image>
							...
							<div className="serviceTContainer">
								<div className="tLeftService">
									...
									>
										<Image alt="green bg" src={greenHere}></Image>
										<h4>
											MicaR Compliance <Image alt="Europe flag" id="flag" src={europe} />
										</h4>
									</div>
									<div
										className="textImageCont"
